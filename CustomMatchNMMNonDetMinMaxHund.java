...
public class CustomMatchNMMNonDetMinMaxHund
{
	
	//-------------------------------------------------------------------------
	
	/** Name of game we wish to play */
	static final String GAME_NAME = "NineMensMorris.lud";
	 ...
	 * Constructor
	 */
	private CustomMatchNMMNonDetMinMaxHund()
	{
		// do not instantiate
	}
	...
	public static void main(final String[] args)
	{
		...
		ais.add(null);
		// player 1
		ais.add(new agents.nonDetMinMax());
		// player 2 
		ais.add(new agents.qLearningHund());	
